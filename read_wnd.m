function [wnd] = read_wnd(filename)

%% Import radiosonde data from text file.%   UNTITLED = IMPORTFILE(FILENAME) Reads data from text file FILENAME for

% Auto-generated by MATLAB on 2017/06/02 15:24:21
